...
**Running example.** The following scenario will be used throughout this post to illustrate parallel execution strategies and their effects. 
...
Block-STM implements correct execution with effective parallelism. It employs
