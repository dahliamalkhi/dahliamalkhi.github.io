...
<pre style="font-size: 14px;">
    ...
    repeat {
        ...
        atomic { if nextValidation < nextPrelimExecution    // if available, steal next read-set validation task
        ...
        else atomic { if nextPrelimExecution <= n         // if available, steal next execution task
