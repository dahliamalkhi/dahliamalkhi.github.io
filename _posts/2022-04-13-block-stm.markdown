...
Each (re-)execution of TX<sub>j</sub> guarantees that read-set validation of all higher transactions will be dispatched by performing
an atomic
<pre style="font-size: 14px;">
...
<pre style="font-size: 14px;">
    ...
    2. parallel execution of TX<sub>2</sub>, TX<sub>3</sub>, TX<sub>4</sub>, TX<sub>5</sub>; read-set validation of TX<sub>3</sub>, TX<sub>4</sub> fail; nextValidation set to 4      
    3. parallel execution of TX<sub>3</sub>, TX<sub>4</sub>, TX<sub>6</sub>, TX<sub>7</sub>; read-set validation of TX<sub>4</sub>, TX<sub>6</sub> fail; nextValidation set to 5      
