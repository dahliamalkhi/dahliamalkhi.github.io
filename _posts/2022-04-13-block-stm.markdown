...
2. Phase 2       
    1. parallel validation of all transactions in which TX<sub>2</sub>, TX<sub>3</sub>, TX<sub>4</sub>, TX<sub>6</sub> fail and re-execute    
    2. continued parallel validation of all transactions in which TX<sub>9</sub> fails and re-executes    
    3. parallel validation of all transactions in which TX<sub>3</sub>, TX<sub>4</sub> fail and re-execute    
    4. parallel validation of all transactions in which TX<sub>4</sub> fails and re-executes    
    5. parallel validation of all transactions in which all succeed
