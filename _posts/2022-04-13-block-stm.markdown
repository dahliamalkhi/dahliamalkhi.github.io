...
<pre style="font-size: 14px;">
    A block B consisting of ten transactions, TX<sub>1</sub>, TX<sub>2</sub>, ..., TX<sub>10</sub>, with the following read/write dependencies:       
...
Recall our running example, a Block B with dependencies TX<sub>1</sub> &rarr; TX<sub>2</sub> &rarr; TX<sub>3</sub> &rarr; {TX<sub>4</sub>, TX<sub>6</sub>, TX<sub>9</sub>}), running with four threads, each transactions taking one time unit (neglecting other computation times).
