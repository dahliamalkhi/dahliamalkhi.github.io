...
**September 20th, 2022 update: A slight revision titled "BFT on a DAG", that subsumes this post, appears [on blog.chain.link](https://blog.chain.link/bft-on-a-dag/)**.
