...
[Narwhal](https://arxiv.org/abs/2105.11827) is a DAG transport after which DAG-T is modeled. It has a layer-by-layer structure, each layer having at most one message per sender and referring to 2F+1 messages in the preceding layer. A similarly layered DAG constructions appeared earlier in
[Aleph, 2019](https://arxiv.org/pdf/1908.05156.pdf).
