...
actually wait for Consensus steps/timers to spread transactions.
...
In particular, it seems that if leader(s) of a wave are faulty or slow, some DAG layers wait to fill until consensus timers expires:
