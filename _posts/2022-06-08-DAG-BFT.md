...
Here, a simple and efficient DAG-based BFT (Byzantine Fault Tolerant) Consensus embedding is described.
It is quite possibly the simplest way to build BFT Consensus in a DAG, yet it is extremely efficient.
...
It stands on the shoulders of previous works, but does not adhere to to any one in full, hence it is referred to in this post as **Fin**.
