...
and **Causality**. 
(If you are already familiar with DAG constructions, you don't need to read this section except to know that Consensus is allowed to occasionally invoke `setInfo()` in order to set a meta-information field piggybacked on future messages.)
