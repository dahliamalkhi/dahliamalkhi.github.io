...
# Quorum Certified Broadcast (QC): The Core Sub-Protocol of HotStuff 
...
This post describes the key building block employed in HotStuff, a *Quorum Certified Broadcast* ("QC"), depicted in Figure 1 below. 
The original [HotStuff: Three-Chain Rules](https://malkhi.com/posts/2019/08/hotstuff-three-chain-rules/) requires chaining three QC phases as a core sub-protocol operated by each leader. 

---

![image](/images/HS/vpcbc.png)

**Figure 1:** 1-phase, 2-phase, 3-phase QC Broadcasts (left), and a QC iconic representations (right).

---

A single phase of the Quorum Certified Broadcast (QC) is a twist on a common building block, Consistent
...
Specifically, in 1-phase , a sender invokes QC-send($m$, $V$) by broadcasting $m$ and
...
**Algorithm 1.** 1-phase, 2-phase, 3-phase Quorum Certified Broadcast (QC). 

---

## 2-Phase  QC

In 2-phase QC, another round of validator voting is added. Each validator
