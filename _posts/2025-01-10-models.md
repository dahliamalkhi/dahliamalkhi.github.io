...
Below I listed some core model terms, shown Capitalized, and gave a brief definition. For each of them, it would be great if our community had common reference points, so we could simply write *"this paper is in the XX model of [@ref]"*.
...
Channels*, every pair of parties can communicate over 
