...
a BFT Consensus embedded in a DAG which is and designed for the partial synchrony model, operates in one-phase, and is completely out of the criticical path of DAG transaction spreading. 
...
| Protocol | Model | External messages used | DAG must be layered | Transmission waits for Consensus | Commit latency in DAG rounds during synchrony | 
| :--- | :--- | :--- | :--- | :-- | :--- |
