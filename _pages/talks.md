...
| :--- |  :-- | :--- |
| **Research Advances in Scaling BFT Consensus** <br><br> &emsp;&emsp; _This talk gives a glimple onto a decade of innovation in scaling BFT Consensus which has been sparked by blockchains. Solutions to open problems emerged under three fault models, synchronous, asynchronous, and partially synchronous, harnerssing insights from the blockchain arena which led to new solution approaches._ | [[Financial Crypto 2024]](https://fc24.ifca.ai/program.html) | |
