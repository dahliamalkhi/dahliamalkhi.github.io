...
| *HotStuff-2: Optimal Two-Phase Responsive BFT*.<br> Dahlia Malkhi, Kartik Nayak. [ConsensusDay23](https://research.protocol.ai/sites/consensusday23/). | [[🗞️-*"Difference between PBFT, Tendermint, HotStuff, and HotStuff-2"*]](https://decentralizedthoughts.github.io/2023-04-01-hotstuff-2/)<br> (See also [[🗞️-*"HotStuff and Casper"*]](https://malkhi.com/posts/2018/03/bft-lens-casper/), [[🗞️-*"PBFT, Tendermint, Casper and HotStuff"*]](https://malkhi.com/posts/2018/04/BFT-lens-tndrmnt/)) <br> [[📄-ePrint]](https://eprint.iacr.org/2023/397) <br>[[🎥-SC23]](https://www.youtube.com/watch?v=iZjfYRH4fVM)| 
| **2022** ||
...
| *Maximal Extractable Value (MEV) Protection on a DAG*.<br>   Dahlia Malkhi, Pawel Szalachowski. [CESC22](https://cesc.io/), [Tokenomics22](https://tokenomics-conference.lip6.fr/index.php?n=Main.Tokenomics2022), [SEC22](https://tselab.stanford.edu/workshop-sbc22/). |  [[🗞️-*"MEV Resistance on a DAG"*]](https://blog.chain.link/mev-resistance-on-a-dag/)<br> (See also [[🗞️-*"BFT on a DAG*"]](https://blog.chain.link/bft-on-a-dag/)) <br>  [[📄-ArXiv]](https://arxiv.org/abs/2208.00940)<br> [[🎥-CESC22]](https://youtu.be/q5v3tLLoOXM) <br> [[🎥-SEC22]](https://www.youtube.com/watch?v=9WLoJRrnTsA&list=PL4XSNxeZhdqBBgqqokIdK4PcyPSl6t0rQ&index=6) |
| *Block-STM: Scaling Blockchain Execution by Turning Ordering Curse to a Performance Blessing*.<br>   Rati Gelashvili, Alexander Spiegelman, Zhuolun Xiang, George Danezis, Zekun Li, Yu Xia, Runtian Zhou, Dahlia Malkh. [PPoPP23](https://conf.researchr.org/home/PPoPP-2023), [ConsensusDay22](https://research.protocol.ai/sites/consensusday22/). | [[🗞️-*"Block-STM"*]](https://blog.chain.link/block-stm/)<br> (See also [[🗞️-*"Parallel Execution on a DAG"*]](https://blog.chain.link/execution-and-parallelism-for-dag-based-bft-consensus/)) <br>  [[📄-ArXiv]](https://arxiv.org/abs/2203.06871)<br> [[📄-PPoPP23]]({{ base_path }}/files/BlockSTM-ppopp23.pdf) | 
