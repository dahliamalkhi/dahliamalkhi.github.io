...
| :--- | :--- | :-- | :--- |
| Byzantine Consensus under Fully Fluctuating Participation |  Dahlia Malkhi, Atsuki Momose, Ling Ren | ArXiv | [📄](https://eprint.iacr.org/2022/1448),<br> [🗞️](https://blog.chain.link/instant-finality-in-byzantine-generals-with-unknown-and-dynamic-participation/),<br> [🗞️](https://blog.chain.link/instant-finality-in-byzantine-atomic-broadcast-under-unknown-dynamic-participation/) |
| Maximal Extractable Value (MEV) Protection on a DAG |   Dahlia Malkhi, Pawel Szalachowski | [CESC 2022](https://cesc.io/), [Tokenomics 2022](https://tokenomics-conference.lip6.fr/index.php?n=Main.Tokenomics2022) |[📄](https://arxiv.org/abs/2208.00940),<br> [🎥](https://youtu.be/q5v3tLLoOXM) |
...
| Strengthened Fault Tolerance in Byzantine Fault Tolerant Replication |   Zhuolun Xiang, Dahlia Malkhi, Kartik Nayak and Ling Ren | [ICDCS 2021](https://icdcs2021.us/) |[📄](https://arxiv.org/abs/2101.03715) |
...
| Cogsworth: Byzantine Round Synchronization |   Oded Naor, Mathieu Baudet, Dahlia Malkhi, Alexander Spiegelman | [CES 2020](https://cryptoeconomicsystems.pubpub.org/ces20) |[📄](https://arxiv.org/abs/1909.05204) |
...
|  Revisiting the Paxos Foundations: A Look at Summer Internship Work at VMware Research | Heidi Howard, Dahlia Malkhi, and Alexander Spiegelman |  SIGOPS Oper. Syst. Rev. 51, 1, 2017. | [📄]({{ base_path }}/files/FPaxos-OSR2017.pdf) |
|  Apache REEF: Retainable Evaluator Execution Framework. | 27 co-authors including me | ACM TOCS 2017 | [📄]({{ base_path }}/files/reef-TOCS2017.pdf) |
|  Dynamic Reconfiguration: Abstraction and Optimal Asynchronous Solution. | Alexander Spiegelman, Idit Keidar, Dahlia Malkhi | DISC 2017 | [📄]({{ base_path }}/files/DynamicReconfig-DISC2017.pdf) | 
|  vCorfu: A Cloud-Scale Object Store on a Shared Log. | Michael Wei, Amy Tai, Christopher J. Rossbach, Ittai Abraham, Maithem Munshed, Medhavi Dhawan, Jim Stabile, Udi Wieder, Scott Fritchie, Steven Swanson, Michael J. Freedman , Dahlia Malkhi | NSDI 2017 |  [📄]({{ base_path }}/files/vcorfu-nsdi20172.pdf) | 
...
|   *REEF: Retainable Evaluator Execution Framework.* | 16 co-authors, including me. SIGMOD 2015. | SIGMOD 2015 | [📄]({{ base_path }}/files/REEF-SIGMOD2015.pdf) | 
...
|   *Tango: Distributed Data Structures over a Shared Log*. | Mahesh Balakrishnan, Dahlia Malkhi, Teb Wobber, Ming Wu, Vijay Prabhakaran, Michael Wei, John Davis, Sriram Rao, Tao Zou, Aviad Zuck. | SOSP 2013. | [📄]({{ base_path }}/files/Tango-SOSP2013.pdf) |
|   *Spanner's Concurrency Control.* | Dahlia Malkhi and Jean-Phillipe Martin. | ACM SIGACT News, Distributed Coomputing Column, 2013. | [📄]({{ base_path }}/files/SpannerExplained-SIGACT2013b.pdf) |
...
|   *Dynamic Reconfiguration of Primary/Backup Clusters.* | Alex Shraer, Ben Reed, Dahlia Malkhi, Falviu Junqueira. | USENIX ATC 2012. | [📄]({{ base_path }}/files/ZooKeeperReconfig-ATC2012.pdf) |
...
|   *Compact Multicast Routing*. | Ittai Abraham, Dahlia Malkhi, David Ratajczak. | DISC 2009. | [📄]({{ base_path }}/files/CompactMulticast-DISC2009.pdf) |
|   *On the Treeness of Internet Latency and Bandwidth*. | Venu Ramasubramanian, Dahlia Malkhi, Fabian Kuhn, Mahesh Balakrishnan, Archite Gupta, Aditya Akella. | SIGMETRICS 2009. | [📄]({{ base_path }}/files/Treeness-SIGMETRICS2009.pdf) |
|   *RPC Chains: Efficient Client-Server Communication in Geodistributed Systems.* | Yee Jiun Song, Marcos Aguilera, Rama Kotla, Dahlia Malkhi. | NSDI 2009. | [📄]({{ base_path }}/files/RPCChains-NSDI2009.pdf) |
|   *Chasing the Weakest System Model for Implementing Ω and Consensus.* | Martin Hutle, Dahlia Malkhi, Ulrich Schmid, Lidong Zhou. | IEEE TDSC 2009 | [📄]({{ base_path }}/files/WeakestOmega-SSS2006.pdf) |
|   *Differential RAID: Rethinking RAID for SSD Reliability*. | Mahesh Balakrishnan, Asim Kadav, Vijayan Prabhakaran, Dahlia Malkhi. | Eurosys 2010 | [📄]({{ base_path }}/files/Diffraid-Hotstorage2009.pdf) |
...
|   *Compact Name-Independent Routing with Minimum Stretch.* | Ittai Abraham, Cyril Gavoille, Dahlia Malkhi, Noam Nisan, Mikkel Thorup. | SPAA 2004 | [📄]({{ base_path }}/files/minstretch-TALG2008.pdf) |
|   *Efficient distributed approximation algorithms via probabilistic tree embeddings.* | Maleq Khan, Fabian Kuhn, Dahlia Malkhi, Gopal Pandurangan, Kunal Talwar. |  PODC 2008. | [📄]({{ base_path }}/files/EfficientApproxTree-PODC2008.pdf) |
...
|   *On Space-Stretch Trade-Offs: Upper bounds.* | Ittai Abraham, Cyril Gavoille, Dahlia Malkhi. | ACM Symposium on Parallel Algorithms and Architectures (SPAA), 2006. | [📄]({{ base_path }}/files/stretch-UB-SPAA2006.pdf) |
|   *On Space-Stretch Trade-Offs: Lower bounds.* | Ittai Abraham, Cyril Gavoille, Dahlia Malkhi. | ACM Symposium on Parallel Algorithms and Architectures (SPAA), 2006. | [📄]({{ base_path }}/files/stretch-LB-SPAA2006.pdf) |
...
|   *Name Independent Routing for Growth Bounded Networks.* | Ittai Abraham, Dahlia Malkhi. | SPAA 2005 | [📄]({{ base_path }}/files/nameindep-gb-SPAA2005.pdf) |
|   The Julia Content Distribution Network. | Danny Bickson, Dahlia Malkhi. | The 2nd Usenix Workshop on Real Large Distributed Systems (WORLDS) 2005. | [📄]({{ base_path }}/files/julia-WORLDS2005.pdf) |
|   *Ω Meets Paxos: Leader Election and Stability without Eventual Timely Links.* | Dahlia Malkhi, Florin Oprea, Lidong Zhou. | DISC 2005 | [📄]({{ base_path }}/files/OmegaMeetsPaxos-DISC2005.pdf) |
|   *Practical Locality-Awareness for Large Scale Information Sharing*. | Ittai Abraham, Ankur Badola, Danny Bickson, Dahlia Malkhi, Sahrad Maloo, Saar Ron. | International Workshop on Peer-To-Peer Systems (IPTPS) 2005 | [📄]({{ base_path }}/files/PracticalLocalityP2P-IPTPS2005.pdf) | 
...
|   *Objects Shared by Byzantine Processes.* | Dahlia Malkhi, Michael Merrit, Mike Reiter, Gadi Taubenfeld. | Distributed Computing 2003 | [📄]({{ base_path }}/files/bqs-objects-DISC2000.pdf) |
...
|   *Dynamic Lookup Networks: A position paper.* | Dahlia Malkhi. | FUDICO 2002. | [📄]({{ base_path }}/files/DynamicLookup-FUDICO2002.pdf) |
|   *A Data-Centric Approach for Scalable State Machine Replication*. | Gregory Chockler, Dahlia Malkhi, Danny Dolev. | The International Workshop on Future Directions in Distributed Computing (FuDiCo), LNCS Volume 2584, 2002. | [📄]({{ base_path }}/files/datacentric-FUDICO2002.pdf) |
|   *Scalable Secure Storage when Half the System is Faulty.* | Noga Alon, Haim Kaplan, Michael Krivelevich, Dahlia Malkhi, Julien Stern. | ICALP 2000 | [📄]({{ base_path }}/files/SecureStore2F-INC-addendum-2003.pdf) |
...
|   *Efficient Update Diffusion in Byzantine Environments*. | Dahlia Malkhi, Mike Reiter, Ohad Rodeh, Yaron Sella. | SRDS 2001 | [📄]({{ base_path }}/files/EfficientByzGossip-SRDS2001.pdf) |
|   *Optimal Unconditional Information Diffusion.* | Dahlia Malkhi, Elan Pavlov, Yaron Sella. | DISC 2001 | [📄]({{ base_path }}/files/OptimalByzGossip-DISC2001.pdf) |
...
|   *Persistent Objects Fleet System.* | Dahlia Malkhi, Mike Reiter, Daniela Tulone, Elisha Ziskind. | DARPA DISCEX II 2001 | [📄]({{ base_path }}/files/Fleet-DISCEX2001.pdf) |
...
|   *An Architecture for Survivable Coordination.* | Dahlia Malkhi, Mike Reiter. | IEEE Transactions on Knowledge and Data Engineering (TKDE) 2000 | [📄]({{ base_path }}/files/Fleet-TKDE2000.pdf) |
|   *Secure Reliable Multicast Protocols in a WAN.* | D. Malkhi, M. Merritt and O. Rodeh. | Distributed Computing 13:19--28, 2000 ; ICDCS 1997 | [📄]({{ base_path }}/files/WANsecure-multicast-ICDCS97.pdf). |
