...
| :--- | :--- | :-- | :--- |
|  Revisiting Fast Practical Byzantine Fault Tolerance. | Ittai Abraham, Guy Gueta, Dahlia Malkhi; with Lorenzo Alvisi, Rama Kotla, Jean-Philippe Martin. [ArXiv 2017](http://arxiv.org/abs/1712.01367)  [pdf]({{ base_path }}/files/revisit-fast-practical-arxiv20172.pdf)
...
-   *Distributed Resource Discovery in Sub-Logarithmic Time*.
    ...
    PODC 2015. [pdf]({{ base_path }}/files/SublogDiscovery-PODC2015.pdf)
-   *REEF: Retainable Evaluator Execution Framework.*
    16 co-authors, including me. SIGMOD 2015. [pdf]({{ base_path }}/files/REEF-SIGMOD2015.pdf)

#### 2014

-   *Optimal Gossip with Direct Addressing*.
    Bernhard Haeupler, Dahlia Malkhi.
    PODC 2014. [pdf]({{ base_path }}/files/DirectAdressing-PODC2014.pdf)
...
-   *Beyond Block I/O: Implementing a Distributed Shared Log in Hardware*.
    ...
    SYSTOR 2013. [pdf]({{ base_path }}/files/CorfuHW-SYSTOR2013.pdf)
-   *CORFU: A Distributed Shared Log*.
    Mahesh Balakrishnan, Dahlia Malkhi, John Davis, Vijay Prabhakaran, Michael Wei, Teb Wobber.
    ACM Transactions on Computer Systems 2013. [pdf]({{ base_path }}/files/CORFU-TOCS2013.pdf)
...
-   *Dynamic Atomic Storage Without Consensus*.
    ...
    PODC 2009 [pdf]({{ base_path }}/files/DynaStore-JACM2011.pdf)
...
-   *Virtually Synchronous Methodology for Dynamic Service Replication.*
    ...
    MSR Tech Report, 2010. [pdf]({{ base_path }}/files/bmvr-virtsync.pdf)
...
-   *Fast Asynchronous Consensus with Optimal Resilience*.
    ...
    DISC 2010. [pdf]({{ base_path }}/files/asynch2fplus1-DISC2010.pdf)
...
-   *Compact Multicast Routing*.
    ...
    DISC 2009. [pdf]({{ base_path }}/files/CompactMulticast-DISC2009.pdf)
-   *On the Treeness of Internet Latency and Bandwidth*.
    ...
    SIGMETRICS 2009. [pdf]({{ base_path }}/files/Treeness-SIGMETRICS2009.pdf)
...
-   *Compact Name-Independent Routing with Minimum Stretch.*
    ...
    SPAA 2004 [pdf]({{ base_path }}/files/minstretch-TALG2008.pdf)
-   *Efficient distributed approximation algorithms via probabilistic tree
    ...
    PODC 2008. [pdf]({{ base_path }}/files/EfficientApproxTree-PODC2008.pdf)
...
-   *Efficient Large Scale Content Distribution.*
    ...
    The 6th Workshop on Distributed Data and Structures (WDAS), 2004. [pdf]({{ base_path }}/files/julia-WDAS2004.pdf)
-   *Fairplay: A Secure Two-Party Computation System*.
    Dahlia Malkhi, Noam Nisan, Benny Pinkas, Yaron Sella. [pdf]({{ base_path }}/files/Fairplay-usenix2004.pdf)
...
-   *A Generic Scheme for Building Overlay Networks in Adversarial Scenarios.*
    ...
    Proceedings of the 17th International Symposium on Parallel and Distributed Processing (IPDPS), 2003. [pdf]({{ base_path }}/files/generic-overlay-IPDPS2002.pdf)
-   *Diffusion without False Rumours: On Propagating Updates in a Byzantine Environment.*
    ...
    TCS 2003 [pdf]({{ base_path }}/files/ByzGossip-SRDS1999.pdf)
-   *Objects Shared by Byzantine Processes.*
    Dahlia Malkhi, Michael Merrit, Mike Reiter, Gadi Taubenfeld.
    Distributed Computing 2003 [pdf]({{ base_path }}/files/bqs-objects-DISC2000.pdf)
...
-   *Viceroy: A Scalable and Dynamic Emulation of the Butterfly.*
    ...
    ACM Symposium on Principles of Distributed Computing (PODC), 2002. [pdf]({{ base_path }}/files/viceroy-PODC2002.pdf)
-   *From Byzantine Agreement to Practical Survivability.*
    keynote at RCDS 2002. [pdf]({{ base_path }}/files/bqs-position-RCDS2002.pdf)
-   *Dynamic Lookup Networks: A position paper.*
    Dahlia Malkhi.
    FUDICO 2002. [pdf]({{ base_path }}/files/DynamicLookup-FUDICO2002.pdf)
...
-   *Scalable Secure Storage when Half the System is Faulty.*
    ...
    ICALP 2000 [pdf] ;]({{ base_path }}/files/SecureStore2F-INC-addendum-2003.pdf)

#### 2001

-   *Replication by Diffusion in Large Networks.*
    Dahlia Malkhi, Yaron Sella.
    Ersads 2001 [pdf]({{ base_path }}/files/ByzReplication-ERSADS2001.pdf)
-   *A Quorum Based Approach to CORBA Fault-Tolerance.*
    ...
    2001 [pdf]({{ base_path }}/files/CORBA-ERSADS2001.pdf)
-   *Efficient Update Diffusion in Byzantine Environments*.
    Dahlia Malkhi, Mike Reiter, Ohad Rodeh, Yaron Sella.
    SRDS 2001 [pdf]({{ base_path }}/files/EfficientByzGossip-SRDS2001.pdf)
-   *Optimal Unconditional Information Diffusion.*
    Dahlia Malkhi, Elan Pavlov, Yaron Sella.
    DISC 2001 [pdf]({{ base_path }}/files/OptimalByzGossip-DISC2001.pdf)
-   *Probabilistic Quorum Systems.*
    Dahlia Malkhi, Mike Reiter, Avishai Wool, Rebecca Wright.
    PODC 1997 [pdf]({{ base_path }}/files/pquorums-inco2001.pdf)
-   *Persistent Objects Fleet System.*
    Dahlia Malkhi, Mike Reiter, Daniela Tulone, Elisha Ziskind.
    DARPA DISCEX II 2001 [pdf]({{ base_path }}/files/Fleet-DISCEX2001.pdf)
-   *On k-set consensus problems in asynchronous systems.*
    R. De Prisco, D. Malkhi and M. K. Reiter .
    PODC 1999 [pdf]({{ base_path }}/files/KsetAsyncByzantine-TPDS2001.pdf)

#### 2000

-   *The Load and Availability of Byzantine Quorum Systems.*
    Dahlia Malkhi, Mike Reiter, Avishai Wool.
    Siam Journal of Computing 2000 [pdf]({{ base_path }}/files/bqsload-PODC1997.pdf)
-   *Dynamic Byzantine Quorum Systems.*
    Lorenzo Alvisi, Dahlia Malkhi, Evelyn Pierce, Mike Reiter, Rebecca Wright.
    ICDSN 2000 [pdf]({{ base_path }}/files/bqs-dynamic-DSN2000.pdf)
-   *An Architecture for Survivable Coordination.*
    Dahlia Malkhi, Mike Reiter.
    IEEE Transactions on Knowledge and Data Engineering (TKDE) 2000 [pdf]({{ base_path }}/files/Fleet-TKDE2000.pdf)
-   *Secure Reliable Multicast Protocols in a WAN.*
    D. Malkhi, M. Merritt and O. Rodeh.
    Distributed Computing 13:19--28, 2000 ; ICDCS 1997 [pdf]({{ base_path }}/files/WANsecure-multicast-ICDCS97.pdf).

#### 1999

-   *Quorum Systems.*
    Dahlia Malkhi.
    A tutorial, 1999 [pdf]({{ base_path }}/files/Quorums1999.pdf)
-   *Fault Detection for Byzantine Quorum Systems.*
    Lorenzo Alvisi, Dahlia Malkhi, Evelyn Pierce, Mike Reiter.
    DCCA 1999 [pdf]({{ base_path }}/files/bqs-fd-DCCA1999.pdf)

#### 1998

-   *Probabilistic Byzantine Quorum Systems*.
    Dahlia Malkhi, Mike Reiter, Avishai Wool, Rebecca Wright.
    Brief announcement at PODC 98 [pdf]({{ base_path }}/files/ByzPquorums-PODC1998.pdf)
-   *Byzantine Quorum Systems.*
    Dahlia Malkhi, Mike Reiter.
    Distributed Computing 1998 [pdf]({{ base_path }}/files/byzquorums-STOC1997.pdf)
-   *Survivable Consensus Objects.*
    Dahlia Malkhi, Mike Reiter.
    SRDS 1998 [pdf]({{ base_path }}/files/bqs-consensus-SRDS1998.pdf)
-   *Secure and Scalable Replication in Phalanx*.
    Dahlia Malkhi, Mike Reiter.
    SRDS 1998 [pdf]({{ base_path }}/files/bqs-phalanx-SRDS1998.pdf)
-   *Auditable Metering with Lightweight Security.*
    Matthew Franklin, Dahlia Malkhi.
    The Journal of Computer Security, 6(4), 1998 [pdf]({{ base_path }}/files/AuditableMetering-TCS1998.pdf) ; Financial Cryptography (FC) 1997

#### 1997

-   *A High-Throughput Secure Reliable Multicast Protocol.*
    Dahlia Malkhi and Mike Reiter.
    The Journal of Computer Security, 5:113, 1997. [pdf]({{ base_path }}/files/SecureMulticast-JCS1997.pdf)
...
-   *The Transis Approach to High Availability Cluster Communication*.
    ...
    Communications of the ACM, 39(4):64--70, April, 1996. [pdf]({{ base_path }}/files/Transis-CACM1994.pdf)
-   *Warm Backup using Snooping.*
    Danny Dolev, Dalia Malki, Yuval Yarom.
    First International Workshop on Services in Distributed and Networked Environments (SDNE), Prague, Czech Republic, June 1994, pp. 60-65. [pdf]({{ base_path }}/files/WarmBackup-SDNE1994.pdf)
-   *The Design of the Transis System.*
    Danny Dolev and Dalia Malki.
    Proceedings of the Dagstuhl Intl. Workshop on Unifying Theory and Practice in Distributed Computing, 1994, pp. 83-98. [pdf]({{ base_path }}/files/Transis-DAGSTUHL1994.pdf)
-   *Early Delivery Totally Ordered Broadcast in Asynchronous Environments.*
    Danny Dolev, Shlomo Kramer and Dalia Malki.
    Proceedings of the 23nd Annual International Symposium on Fault-Tolerant Computing (FTCS), June 1993, pp. 544-553. [pdf]({{ base_path }}/files/Multicast-FTCS1993.pdf)
-   *Membership Algorithms for Multicast Communication Groups.*
    Yair Amir, Danny Dolev, Shlomo Kramer and Dalia Malki.
    Proceedings of the 6th Intl. Workshop on Distributed Algorithms (WDAG-6), Haifa, Israel, Nov. 1992, pp. 292-312. [pdf]({{ base_path }}/files/TransisMemb-WDAG1992.pdf)
-   *Transis: A Communication Sub-System for High Availability.*
    Yair Amir, Danny Dolev, Shlomo Kramer and Dalia Malki.
    Proceedings of the 22nd Annual International Symposium on Fault-Tolerant Computing (FTCS), July 1992, pp. 76-84. [pdf]({{ base_path }}/files/Transis-FTCS1992.pdf)
